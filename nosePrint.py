...
#         # print(label_path)
#         features = extract_features(label_path)
...
# # Example Usage
# dataset_path = '/media/brainwired/D/BW_ML/01_AUG_FARM_TEST/study/Eye_controlled_mouse/Nose_print_data'  # Replace with actual dataset path
